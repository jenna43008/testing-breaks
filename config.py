...
DEFAULT_CONFIG = {
    ...
    "rules": [
        ...
        {"name": "combo_tld_spoof_no_dkim", "score": 0, "label": "tld variant spoofing + no dkim", "category": "TLD Variant Spoofing", "enabled": True, "if_all": ["tld_variant_spoofing", "no_dkim"], "if_any": [], "if_not": []},
        ...
        {"name": "transfer_lock_old_domain", "score": 35, "label": "transfer lock recently added + domain >1yr — post-compromise lockdown on established domain", "category": "Domain Takeover", "enabled": True, "if_all": ["transfer_lock_recent", "domain_gt_1yr"], "if_any": [], "if_not": []},
